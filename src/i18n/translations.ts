...
export const translations: Record<Language, any> = {
  EN: {
    ...
    billUpload: {
      ...
      sampleFactory: 'EDC Factory Bill ($3,450/mo)',
      sampleHotel: 'EDC Hotel / Resort Bill ($1,850/mo)',
      sampleHome: 'EDC Residential Bill ($320/mo)',
      extractedDataTitle: 'Extracted Bill Insights',
      monthlyKWh: 'Monthly Consumption',
      tariffRate: 'Estimated Tariff Rate',
      peakDemand: 'Transformer / Peak Load',
  ...
  KH: {
    ...
    billUpload: {
      ...
      sampleFactory: 'វិក្កយបត្ររោងចក្រ ($3,450/ខែ)',
      sampleHotel: 'វិក្កយបត្រសណ្ឋាគារ ($1,850/ខែ)',
      sampleHome: 'វិក្កយបត្រគេហដ្ឋាន ($320/ខែ)',
      extractedDataTitle: 'ទិន្នន័យដែលទាញចេញពីវិក្កយបត្រ',
      monthlyKWh: 'ការប្រើប្រាស់ប្រចាំខែ (kWh)',
      tariffRate: 'តម្លៃថ្លៃភ្លើងគិតជាមធ្យម',
      peakDemand: 'ទំហំត្រង់ស្វូ / បន្ទុកអតិបរមា',
  ...
  VI: {
    ...
    billUpload: {
      ...
      sampleFactory: 'Hóa đơn Nhà máy EDC ($3,450/tháng)',
      sampleHotel: 'Hóa đơn Khách sạn EDC ($1,850/tháng)',
      sampleHome: 'Hóa đơn Hộ gia đình ($320/tháng)',
      extractedDataTitle: 'Thông Tin Trích Xuất Từ Hóa Đơn',
      monthlyKWh: 'Sản lượng tiêu thụ tháng',
      tariffRate: 'Đơn giá điện trung bình',
      peakDemand: 'Công suất Trạm biến áp / Max',
